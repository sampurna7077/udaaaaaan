...
// Ensure absolute path to JSON DB folder (can be overridden via env var)
const DEFAULT_JSON_DB_FOLDER = path.resolve(
  process.cwd(),
  '06jbjz5PvFtImMG2VzFz6LHiD0Uom5E9ltYCAfKtS2sZAXCixewC4BfqBHBha5HUh328YEL2BBHEKpTe'
);
const JSON_DB_FOLDER = process.env.JSON_DB_FOLDER || DEFAULT_JSON_DB_FOLDER;
