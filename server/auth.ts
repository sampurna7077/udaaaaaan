...
export function setupAuth(app: Express) {
  ...
  // Ensure SESSION_SECRET is provided for security
  ...
  const sessionSettings: session.SessionOptions = {
    ...
    cookie: {
      ...
      sameSite: (process.env.SESSION_COOKIE_SAMESITE as any) || 'strict'
    }
  };
  ...
  app.post("/api/register", async (req, res, next) => {
    try {
      ...
      // Admin roles should be assigned manually via database or environment configuration
